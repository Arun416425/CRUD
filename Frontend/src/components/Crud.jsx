        ...
        <>
            <div className='text-center'>
                ...
                <form onSubmit={handleSubmit}>
                    <input type="text" name='name' placeholder='Name' value={formData.name} onChange={handleChange} className='border p-2 w-75 m-1' required /><br />
                    <input type="number" name='age' placeholder='Age' value={formData.age} onChange={handleChange} className='border p-2 w-75 m-1' required /><br />
                    <input type="text" name='course' placeholder='Course' value={formData.course} onChange={handleChange} className='border p-2 w-75 m-1' required /><br />
                    <input type="text" name='city' placeholder='City' value={formData.city} onChange={handleChange} className='border p-2 w-75 m-1' required /><br />
